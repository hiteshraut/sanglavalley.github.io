		...
		<div class="container header-part">
				...
				<div class="overlay" id="overlay">
				 	<nav class="overlay-menu" style="float: none;">
				  	<div class="container">
				  			<div class="logo-icon" style="padding-top: 23px;">
								<a href="#" onclick="window.location.reload()">	<img src="images/logo.png" alt="LOGO" /></a>
							</div>
		...
		<div id="fh5co-pricing-section" class="text-vertical-center1">
			<div class="container">
				...
				<div class="row" style="margin:0">
					...
					<img src="images/img-why-1.jpg" alt="" style=""  /> 
				<!-- 		<div class="homepage-hero-module">
					...
					<div class="col-md-3 col-sm-6 why2 animate-box">
						...
						<img src="images/img-why-2.jpg" alt="" max-height="400px;" width="100%" /> 
					...
					<div class="col-md-3 col-sm-6 why3 animate-box">
						<img src="images/img-why-3.jpg" alt="" height="200px;" width="100%" /> 
						<div class="why-us3">
							<h5>Away from the crowds </h5>
							<p style="width: 218px;">Credibly e-enable empowered innovation without functionalized human capital. Holisticly coordinate resource sucking "outside the box" thinking with synergistic value. Authoritatively. </p>
							<a href="sangla.html" > Know more</a>
						</div>
					</div>
				</div>
